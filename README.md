...
1. `swift build`
1. `.build/debug/S3_ARServer_Kitura`
...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/S3_ARServer_Kitura` directory. You need to make sure you change the `repository` variable in your `chart/S3_ARServer_Kitura/values.yaml` file points to the docker image containing your runnable application.
